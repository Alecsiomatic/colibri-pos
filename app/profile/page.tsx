      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Tabs defaultValue="profile" className="space-y-6">
          <TabsList className="grid w-full grid-cols-4 bg-white/10 backdrop-blur-sm">
            ...
            <TabsTrigger value="loyalty" className="text-white data-[state=active]:bg-purple-600">
          ...
          <TabsContent value="loyalty" className="space-y-6">
            {loyaltyLoading ? (
              ...
              <>
                {/* Points Card */}
                <Card className="backdrop-blur-sm bg-gradient-to-br from-amber-900/30 to-purple-900/30 border-amber-500/20">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-amber-300 text-sm uppercase tracking-wide">Tus Puntos</p>
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-xs text-purple-300">Multiplicador {loyalty.tier_multiplier}x</p>
                      </div>
                    </div>
                    {loyalty.next_tier && loyalty.points_to_next > 0 && (
                      <div className="mt-4">
                        ...
                        <div className="w-full bg-white/10 rounded-full h-2">
                          <div
                            className="h-2 rounded-full bg-gradient-to-r from-amber-500 to-purple-500 transition-all"
                ...
                <Card className="backdrop-blur-sm bg-white/10 border-purple-500/20">
                  ...
                  <CardContent>
                    {loyaltyTransactions.length > 0 ? (
                      ...
                      <div className="text-center py-8">
                        <Coins className="h-12 w-12 mx-auto text-purple-400/40 mb-3" />
                        <p className="text-purple-300">Aún no tienes movimientos</p>
                        <p className="text-purple-400/60 text-sm">¡Haz tu primera compra para ganar puntos!</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
                    ...
                    <div className="grid grid-cols-4 gap-2 mt-3">
                      {[
                        ...
                        <div key={t.name} className="text-center p-2 rounded-lg bg-white/5">
                          ...
                          <p className="text-xs text-purple-400">{t.mult}</p>
                        </div>
                      ))}
                    </div>
                  </CardContent>
              ...
              <Card className="backdrop-blur-sm bg-white/10 border-purple-500/20">
                <CardContent className="text-center py-12">
                  <Crown className="h-12 w-12 mx-auto text-purple-400/40 mb-3" />
                  <p className="text-purple-200">El programa de lealtad no está disponible</p>
                </CardContent>
              </Card>
            )}
          </TabsContent>
